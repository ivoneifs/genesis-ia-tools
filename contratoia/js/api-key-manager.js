...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'contrato-ia_apikey_';
  ...
  // Multi-model text tool → OpenRouter (one key → every provider) + native OpenAI.
  ...
  // Catalog refreshed from the LIVE OpenRouter ranking on 2026-07-01 — every id
  // was confirmed to exist via GET https://openrouter.ai/api/v1/models.
  const AI_MODELS = {
    claude: {
    ...
    trending: {
      ...
      // Live OpenRouter trending, 2026-07-01.
      models: [
        { id: 'x-ai/grok-4.3', name: 'Grok 4.3 (xAI)' },
        { id: 'z-ai/glm-4.7', name: 'GLM 4.7 (Z.ai)' },
