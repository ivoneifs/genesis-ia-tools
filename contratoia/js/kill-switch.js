...
const KillSwitch = (function() {
  ...
  function showMaintenancePage() {
    ...
    overlay.innerHTML = '<div style="text-align:center;max-width:480px;padding:32px;">' +
      ...
      '<h1 style="font-size:28px;font-weight:800;margin-bottom:16px;background:linear-gradient(135deg,#1b2b3a,#8a2b2b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">Em Manutenção</h1>' +
      '<p style="color:#5c6b7a;font-size:16px;line-height:1.6;margin-bottom:24px;">Estamos realizando melhorias nesta ferramenta. Ela estará de volta em breve.</p>' +
      '<div style="display:inline-block;background:rgba(154,123,63,.14);color:#8a2b2b;padding:8px 20px;border-radius:100px;font-size:13px;font-weight:600;border:1px solid rgba(154,123,63,.30);">Gênesis IA</div>' +
      '</div>';
