...
const KillSwitch = (function() {
  ...
  function showMaintenancePage() {
    ...
    overlay.innerHTML = '<div style="text-align:center;max-width:480px;padding:32px;">' +
      ...
      '<div style="display:inline-block;background:rgba(167,139,250,.12);color:#a78bfa;padding:8px 20px;border-radius:100px;font-size:13px;font-weight:600;border:1px solid rgba(167,139,250,.2);">Gênesis IA</div>' +
      '</div>';
