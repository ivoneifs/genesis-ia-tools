...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'faturas-ia_apikey_';
  ...
  const ENABLED_SERVICES = ['openrouter', 'openai']; // OpenRouter (multi-model picker) + OpenAI native
  ...
  // Refreshed 2026-06-05 against the live OpenRouter catalog (/api/v1/models).
  const AI_MODELS = {
    claude: {
