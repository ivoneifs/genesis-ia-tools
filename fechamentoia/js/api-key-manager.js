...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'fechamento-ia_apikey_';
  ...
  // Refreshed from the LIVE OpenRouter catalog on 2026-07-09 (347 models); exact ids
  // verified routable via /api/v1/models. Trending group bumped grok-4.3 → grok-4.5.
  const AI_MODELS = {
    claude: {
    ...
    trending: {
      ...
      // Live OpenRouter trending — refreshed 2026-07-09.
      models: [
