...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'notas_ia_apikey_';
  ...
  // Notas-IA uses OpenAI-compatible chat completion endpoints.
  // OpenRouter is included because its TEST_OPENROUTER_KEY is the only
  // test key with remaining credit for browser verification.
