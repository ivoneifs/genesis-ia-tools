...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'planilhas-ia_apikey_';
  ...
  // OpenRouter primary (one key → every model in the picker); OpenAI + Google (Gemini)
  // native fallbacks (many members already have a Gemini key from the free tier).
  ...
  // Refreshed from the LIVE OpenRouter ranking at build time (2026-07-25).
  const AI_MODELS = {
    claude: {
    ...
    trending: {
      ...
      // Live OpenRouter trending, 2026-07-25.
      models: [
