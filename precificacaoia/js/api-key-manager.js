...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'precificacao-ia_apikey_';
  ...
  // OpenRouter first (preferred: one BYOK key reaches every provider in the picker,
  // Hard Rule #19). OpenAI + Gemini are native single-provider fallbacks.
  ...
  // Refreshed 2026-07-19 from the live OpenRouter ranking (openrouter.ai/api/v1/models).
  const AI_MODELS = {
    claude: {
    ...
    openai: {
      ...
      models: [
        ...
        { id: 'openai/gpt-5.4-mini', name: 'GPT-5.4 mini (econômico)' }
      ]
    },
    google: {
      label: 'Google (Gemini)',
      models: [
        ...
        { id: 'google/gemini-3.1-flash-lite', name: 'Gemini 3.1 Flash Lite (econômico)' }
      ]
    },
    deepseek: {
      label: 'DeepSeek',
    ...
    trending: {
      ...
      // Refreshed 2026-07-19 from the live OpenRouter ranking.
      models: [
