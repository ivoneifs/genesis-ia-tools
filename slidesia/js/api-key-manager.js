...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'slides-ia_apikey_';
  ...
  // Slides IA is a multi-model text tool → route through OpenRouter (one BYOK key
  // reaches every provider in the picker) + native OpenAI as a fallback option.
  ...
  // Refreshed from the LIVE OpenRouter ranking at build time — 2026-06-22.
  const AI_MODELS = {
    claude: {
    ...
    trending: {
      ...
      // Live OpenRouter trending — 2026-06-22.
      models: [
